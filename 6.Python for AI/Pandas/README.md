...
## Creating Virtual Environment On terminal

- uv init .

- uv add pandas

- uv run (specific python file)
...
### **3.2 Conditional Filtering (Boolean masks)**
...
## **4. CRUD Operations in Pandas**

### **4.1 Create (Insert Rows)**
